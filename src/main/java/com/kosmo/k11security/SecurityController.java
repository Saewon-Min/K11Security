...
public class SecurityController {
	...
	public String securityIndex2(Principal principal,
		...
		/*
		controller에서 시큐리티를 통해 로그인 한 사용자 정보를 얻어오기
			: @Controller로 선언된 클래스에서는 메소드 인자로 Principal객체를
	...
	public String securityIndex2Login(Principal principal,
			Model model) {
